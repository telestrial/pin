...
- **A "People you follow" surface.** Handle-follow ships today, but it's only reachable by navigating to someone's handle directory and clicking Follow — there's no single place to see or manage who you follow. A dedicated surface (a sidebar section or its own view) listing your handle-follows, each linking back to their directory with unfollow inline, is the natural next slice.
