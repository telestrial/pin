...
export const endorse_rkey: (a: number, b: number, c: number, d: number, e: number, f: number) => [number, number];
export const endorsement_verify: (a: number, b: number) => [number, number];
export const engagement_subject: (a: number, b: number, c: number, d: number) => [number, number];
...
export const sign_endorsement: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number, m: number, n: number) => [number, number, number, number];
